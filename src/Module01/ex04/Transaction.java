...
public class Transaction {
    ...
    public Transaction(User recipient, User sender, Integer amount, TransferCategory category, UUID id) {
        this.Identifier = id;
        ...
        // Check the amount sign matches the type
        ...
        // Check sender has enough balance for debit
        if (category == TransferCategory.DEBIT && sender.getBalance() < Math.abs(amount)) {
